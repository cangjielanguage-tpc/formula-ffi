...
private:
    ...
    void createCompoundBoxes(TeXEnvironment& env);
    void layoutSubschemeInternals();
    void layoutSubschemeBounds(TeXEnvironment& env);
    void buildLayoutElements(std::vector<std::pair<bool, int>>& layoutElements);
    void linearLayoutPass(const std::vector<std::pair<bool, int>>& layoutElements);
    void assignRowDepths(const std::vector<std::pair<bool, int>>& layoutElements);
    void layoutArrowFromOrder(const ArrowElement& arrow, ArrowLayout& alayout, TeXEnvironment& env);
    void layoutPlusFromOrder(const PlusElement& plus, const CompoundLayout& afterCL);
    void layoutArrows(TeXEnvironment& env);
    void layoutSubschemeArrows(TeXEnvironment& env);
    void layoutMerges();
